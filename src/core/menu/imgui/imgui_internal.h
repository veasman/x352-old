...
namespace ImGui
{
    ...
    IMGUI_API void          RenderFrameGradient(ImVec2 p_min, ImVec2 p_max, ImU32 tl, ImU32 tr, ImU32 br, ImU32 bl, bool border = true, float rounding = 0.0f);
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0, bool indent = false);
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonExSpecial(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          InputTextExIndent(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
