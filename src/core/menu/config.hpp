    ...
    inline std::unordered_map<std::string_view, ConfigItem> config {
        ...
        // Visuals {
            // ESP {
                ...
                CONFIGITEM("Visuals>Players>Enemies>Box Color", ImColor(255, 255, 255, 255)),
                CONFIGITEM("Visuals>Players>Enemies>Skeleton", false),
                CONFIGITEM("Visuals>Players>Enemies>Skeleton Color", ImColor(255, 255, 225, 255)),
                CONFIGITEM("Visuals>Players>Enemies>Name", false),
                CONFIGITEM("Visuals>Players>Enemies>Health", false),
                CONFIGITEM("Visuals>Players>Enemies>Health Bar Color", ImColor(0, 255, 0, 255)),
                ...
                CONFIGITEM("Visuals>Players>Teammates>Box Color", ImColor(255, 255, 255, 255)),
                CONFIGITEM("Visuals>Players>Teammates>Skeleton", false),
                CONFIGITEM("Visuals>Players>Teammates>Skeleton Color", ImColor(255, 255, 225, 255)),
                CONFIGITEM("Visuals>Players>Teammates>Name", false),
                CONFIGITEM("Visuals>Players>Teammates>Health", false),
                CONFIGITEM("Visuals>Players>Teammates>Health Bar Color", ImColor(0, 255, 0, 255)),
            ...
            // Chams {
                ...
                CONFIGITEM("Visuals>Players>LocalPlayer>Velocity Text", false),
