...
class TraceFilterEntitiesOnly : public ITraceFilter
{
public:
    bool ShouldHitEntity(Player* pEntityHandle, int contentsMask)
    {
...
{
public:
    bool ShouldHitEntity(Player* pServerEntity, int contentsMask)
    {
        return false;
    }
    virtual TraceType GetTraceType() const
...
class TraceFilterWorldAndPropsOnly : public ITraceFilter
{
public:
    bool ShouldHitEntity(Player* pServerEntity, int contentsMask)
    {
